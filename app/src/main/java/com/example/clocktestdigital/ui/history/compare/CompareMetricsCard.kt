...
import com.example.clocktestdigital.ui.history.compare.formatMilliseconds
import com.example.clocktestdigital.ui.history.compare.formatTime
...
fun CompareMetricsCard(
    ...
    Card(
        ...
        Column(
            ...
            ComparisonRow(
                label = "Presión media",
                valueA = String.Companion.format(
                    Locale.getDefault(),
                    "%.2f",
                    sessionA.averagePressure
                ),
                valueB = String.Companion.format(
                    Locale.getDefault(),
                    "%.2f",
                    sessionB.averagePressure
                )
            )
            ...
            ComparisonRow(
                ...
                valueA = String.Companion.format(
                    Locale.getDefault(),
                    "%.1f mm/s",
                    sessionA.averageSpeedMmPerSec
                ),
                valueB = String.Companion.format(
                    Locale.getDefault(),
                    "%.1f mm/s",
                    sessionB.averageSpeedMmPerSec
                )
            )
            ...
            ComparisonRow(
                ...
                valueA = String.Companion.format(
                    Locale.getDefault(),
                    "%.1f %%",
                    metricsA.hoverPercentageOfSession
                ),
                valueB = String.Companion.format(
                    Locale.getDefault(),
                    "%.1f %%",
                    metricsB.hoverPercentageOfSession
                )
            )
        }
    }
...
private fun ComparisonRow(
    ...
    Row(
        ...
        Text(
            text = label,
            modifier = Modifier.Companion.weight(1.25f),
